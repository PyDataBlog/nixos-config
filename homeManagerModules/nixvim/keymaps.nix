...
in
{
  keymaps = [
    ...
    (mkLuaNmap "<leader>ad" "function() require('sidekick.cli').close() end" "Close Sidekick CLI")
    (mkLuaNmap "<leader>af" "function() require('sidekick.cli').send({ msg = '{file}' }) end"
      "Send file to Sidekick"
    )
    (mkLuaNmap "<leader>aj" "function() require('sidekick').nes_jump_or_apply() end" "NES jump/apply")
    (mkLuaNmap "<leader>aN" "function() require('sidekick.nes').update() end" "Refresh NES")
    (mkLuaNmap "<leader>an" "function() require('sidekick.nes').toggle() end" "Toggle NES")
    (mkLuaNmap "<leader>ap" "function() require('sidekick.cli').prompt() end" "Prompt Sidekick CLI")
    (mkLuaNmap "<leader>as"
    ...
    (mkLuaNmap "<leader>ax" "function() require('sidekick.nes').clear() end" "Clear NES suggestion")
    ...
    (mkLuaNmap "<leader>bW" "function() MiniBufremove.wipeout(0, true) end"
      "Wipe out buffer forcefully"
    )
    ...
    (mkLuaNmap "<leader>kk" "function() require('kubectl').toggle({ tab = false }) end"
      "kubectl toggle"
    )
    (mkLuaNmap "<leader>kK" "function() require('kubectl').toggle({ tab = true }) end"
      "kubectl toggle in tab"
    )
    ...
    (mkLuaNmap "<leader>dm" "function() require('dap-python').test_method() end"
      "Debug Python test method"
    )
    (mkLuaNmap "<leader>dM" "function() require('dap-python').test_class() end"
    ...
    (mkLuaNmap "<leader>nd" "function() require('neotest').run.run({ strategy = 'dap' }) end"
      "Debug nearest test"
    )
    (mkLuaNmap "<leader>nf" "function() require('neotest').run.run(vim.fn.expand('%')) end"
      "Run test file"
    )
    ...
    (mkLuaNmap "<leader>nO" "function() require('neotest').output_panel.toggle() end"
    ...
    (mkLuaNmap "<leader>nS" "function() require('neotest').run.run(vim.fn.getcwd()) end"
      "Run test suite"
    )
    (mkLuaNmap "<leader>nw" "function() require('neotest').watch.toggle(vim.fn.expand('%')) end"
      "Watch test file"
    )
    ...
    (mkLuaNmap "<leader>sn"
      "function() vim.ui.input({ prompt = 'Session name: ' }, MiniSessions.write) end"
      "Write named session"
    )
    (mkLuaNmap "<leader>sr" "function() MiniSessions.read() end" "Read default session")
